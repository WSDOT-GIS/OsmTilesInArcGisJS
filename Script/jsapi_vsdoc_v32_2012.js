...
esri.symbol.SimpleFillSymbol = function () {
    ...
    /// </signature> = function (style,outline,color) {
    /// <signature>
...
esri.symbol.SimpleLineSymbol = function () {
    ...
    /// </signature> = function (style,color,width) {
    /// <signature>
...
esri.symbol.SimpleMarkerSymbol = function () {
    ...
    /// </signature> = function (style,size,outline,color) {
    /// <signature>
...
esri.symbol.CartographicLineSymbol = function () {
    ...
    /// </signature> = function (style,color,width,cap,join,miterLimit) {
    /// <signature>
...
esri.symbol.TextSymbol = function (text) {
    ...
    /// </signature> = function (text,font,color) {
    /// <signature>
...
esri.symbol.Font = function () {
    ...
    /// </signature> = function (size,style,variant,weight,family) {
    /// <signature>
